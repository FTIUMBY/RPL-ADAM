 ...
 * @var $model UserLevel * @var $form CActiveForm
...
class LevelController extends Controller
{
	...
	public function actionRunAction() {
		...
		if(count($id) > 0) {
			...
			if($actions == 'publish') {
				UserLevel::model()->updateAll(array(
					'publish' => 1,
				),$criteria);
				...
				UserLevel::model()->deleteAll($criteria);
			}
		}
			...
			if(isset($id)) {
				...
				if($model->update()) {
					echo CJSON::encode(array(
						...
						'get' => Yii::app()->controller->createUrl('manage'),
						'id' => 'partial-user-level',
						'msg' => '<div class="errorSummary success"><strong>UserLevel success published.</strong></div>',
					));
				}
			}
