				...
				if(isset($_GET['enablesave']) && $_GET['enablesave'] == 1) {
					if($model->save()) {
						echo CJSON::encode(array(
							...
							'msg' => '<div class="errorSummary success"><strong>Tag success created.</strong></div>',
						));
					} else {
				...
				if(isset($_GET['enablesave']) && $_GET['enablesave'] == 1) {
					if($model->save()) {
						echo CJSON::encode(array(
							...
							'get' => Yii::app()->controller->createUrl('manage'),
							'id' => 'partial-ommu-tags',
							'msg' => '<div class="errorSummary success"><strong>Tag success updated.</strong></div>',
						));
					} else {
						print_r($model->getErrors());
					}
		...
		if(Yii::app()->request->isPostRequest) {
			...
			if(isset($id)) {
				...
				echo CJSON::encode(array(
					...
					'get' => Yii::app()->controller->createUrl('manage'),
					'id' => 'partial-ommu-tags',
					'msg' => '<div class="errorSummary success"><strong>Tag success deleted.</strong></div>',
				));
			}
